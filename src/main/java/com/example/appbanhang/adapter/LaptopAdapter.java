...
public class LaptopAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof ViewHolder){
            ...
            Glide.with(context).load(sanPhamMoi.getHinhanh()).into(viewHolder.imgLt);
//
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            txtTen = itemView.findViewById(R.id.itemlt_ten);
            txtGia = itemView.findViewById(R.id.itemlt_gia);
            txtMota = itemView.findViewById(R.id.itemlt_mota);
            imgLt = itemView.findViewById(R.id.itemlt_image);
